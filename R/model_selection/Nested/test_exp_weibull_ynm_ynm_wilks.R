...
Likelihood_under_H0 <- function(data_rec, params){
  ...
  logLik_fun_rec <-
    loglik_registry[["YNM"]][["records"]][["exp"]]
...
Likelihood_under_H1 <- function(data_rec, params){
  ...
  logLik_fun_rec <-
    loglik_registry[["YNM"]][["records"]][["weibull"]]
...
for(trend_val in trend_values){
  ...
  #
  # Data generated under H1 (Weibull-YNM)
  #
  # H0 : Exponential YNM
  # H1 : Weibull YNM
  #
...
if(save){
  ...
  write.xlsx(sheets_list, file = paste0("data/model_selection/nested/model_selection_exp_",true_params[["rate"]],"_weibull_",H1_params[["shape"]],"_ynm_ynm_T=",T_val,".xlsx"))

  paste0("file written to:" , "data/model_selection/nested/model_selection_exp_",true_params[["rate"]],"_weibull_",H1_params[["shape"]],"_ynm_ynm_T=",T_val,".xlsx")
}
