...
df <- read_excel("data/param_est/dtrw/unif/Simulation_dtrw_Xt_Rn_overT_unif_max=1_biased.xlsx", sheet = "All Par")
df_record <- read_excel("data/param_est/dtrw/unif/Simulation_dtrw_Xt_Rn_overT_unif_max=1_biased.xlsx", sheet = "All Par_record")
...
ggsave("vignettes/plots_output/dtrw/unif/biased/Bias_plot.png",
       bias_plot,
       width = 10,
       height = 6,
       dpi = 300)

ggsave("vignettes/plots_output/dtrw/unif/biased/Coverage_plot.png",
       coverage_plot,
       width = 10,
       height = 6,
       dpi = 300)

ggsave("vignettes/plots_output/dtrw/unif/biased/Variance_plot.png",
       variance_plot,
       width = 12,
       height = 8,
       dpi = 300)
...
ggsave("vignettes/plots_output/dtrw/unif/biased/Avg_NT_plot.png",
       NT_plot,
       width = 8,
       height = 5,
       dpi = 300)
