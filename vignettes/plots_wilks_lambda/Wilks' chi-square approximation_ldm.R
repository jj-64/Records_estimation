...
data <- read_excel("data/model_selection/nested/model_selection_exp_2_weibull_1.2_ldm_ldm_T=75.xlsx",
                                                                  sheet = "type_I_error")
...
ggsave(
  "vignettes/plots_wilks_lambda/wilks_exp_weibull_ldm_ldm.png",
  p,
  width = 10,
  height = 7,
  dpi = 600,
