...
t_values <- c(50, 75, 100)

read_summary_sheet <- function(t_val) {
  file_path <- sprintf("data/model_selection/nested/model_selection_exp_2_weibull_1.2_ynm_ynm_T=%d.xlsx", t_val)
...
palette_t <- c("50" = "#0072B2", "75" = "#E69F00", "100" = "#009E73")
...
#ggsave("vignettes/plots_power_error/plot_Power_TypeI_ynm.pdf", plot = final_figure, width = 11, height = 5, units = "in", dpi = 300)
ggsave("vignettes/plots_power_error/plot_Power_TypeI_ynm2.png", plot = final_figure, width = 11, height = 5, units = "in", dpi = 300)
